        ...
        body: ListView(
          children: <Widget>[
            Container(
              ...
              child: Text("ListView widget digunanakan untuk menampilka data dalam bentuk list dan jika datanya melebihi dari render box maka halaman tersebut dapat di scroll.", style: TextStyle(fontSize:30,color:
Colors.white)),
            ), 
            Container(
              color: Colors.red,
